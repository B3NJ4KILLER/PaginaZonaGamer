            ...
            <div class="col-md-6"><br><br>
                ...
                <form method="POST" action="update.php">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Apellidos" name="apellidos" value="<?php echo $apellidos; ?>" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Nombre de usuario" name="usuario" value="<?php echo $usuario; ?>" required>
                        </div>
                        <div class="col">
                            <input type="tel" class="form-control" placeholder="Número de teléfono" name="telefono" value="<?php echo $telefono; ?>" required>
                        </div>
                    </div>
                    
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">@</span>
                        <input type="email" class="form-control" placeholder="Correo electrónico" name="correo" value="<?php echo $correo; ?>" required>
                    </div>
                    
                    <div class="mb-3 row">
                        <div class="col">
                            <select class="form-select" name="genero" required>
                            <option value="" <?php echo $genero == '' ? 'selected' : ''; ?>>Género</option>
                        ...
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Fecha de nacimiento" name="fecha" value="<?php echo $fecha; ?>" value="Mark" required>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Número de departamento" name="numdepa" value="<?php echo $numdepa; ?>">
                    </div>
                    <div class="mb-3 row">
                        <div class="col">
