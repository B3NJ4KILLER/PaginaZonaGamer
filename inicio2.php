    ...
    <div class="container-fluid">
            ...
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel-slide">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="hogwarts.png" class="d-block w-100" alt="Hogwarts">
                    ...
                    <div class="carousel-item" data-bs-interval="4000">
                        <img src="resident.png" class="d-block w-100" alt="Resident">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img src="minecraft.png" class="d-block w-100" alt="Minecraft">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Minecraft</h5>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
            <div class="col">
                <div class="card h-100">
                    <img src="img-fortnite.jpg" class="card-img-top" alt="img-fortnite">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <video class="card-img-top" src="CS-clip.mp4" muted controls></video>
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="rl-dominus.jpg" class="card-img-top" alt="rl-dominus">
                    <div class="card-body">
        ...
        <div class="container-xxl">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="img-cs.jpg" class="img-fluid" alt="img-cs">
        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-6">
                    <figure class="figure">
                        <img src="zgamerimg.PNG" class="figure-img" alt="zgamerimg">
